...
var bg_home_dinner = [{url: "./img/7/dinner/1-1.png"}, {url: "./img/7/dinner/1-2.png"}, {url: "./img/7/dinner/2-1.png"}, {url: "./img/7/dinner/2-2.png"}, {url: "./img/7/dinner/3-1.png"}, {url: "./img/7/dinner/3-2.png"}];
...
var bg_dad_hit = [{url: "./img/7/dad_hit/06.png", timeout: 2}, {url: "./img/7/dad_hit/07.png", timeout: 1}, {url: "./img/7/dad_hit/08.png", timeout: 2}, {url: "./img/7/dad_hit/23.png", timeout: 2, end: true}];
...
var scene = {
	...
	7101: {
		...
		line: [
			...
			{type: "received", message: "如果你想生，我會負起責任努力轉錢 ; 如果你不想生，我也會陪你。", timeout: 3},
	...
	8301: {
		...
		text_color: "#4d4d4d",
		story: [
		"爸：「你還敢頂嘴？（啪一巴掌）給我回去房間好好反省！」",
		"媽：「說話就好好說話，怎麼還動手呢？」",
		"爸：「是她太不受教了，妳去打電話給老師，問問看要怎麼處理這件事」",
		],
		btn_left: {
			text: "繼續",
 			scene: 9001,
	...
	8501: {
		...
		text_color: "#4d4d4d",
		story: [
		"女：我剛剛有努力試探一下了，我媽超可怕的，直接問我是不是懷孕了？",
		"我知道我只差一步就可以把它說出來，但是我害怕還是不敢說。",
		"男：那小孩怎麼辦？你想要生下來還是？",
		"女：我..我好混亂，不知道該怎麼辦。你呢？你覺得怎麼辦？",
		"男：我覺得我們只是個高中生，沒有能力照顧自己，更何況去照顧小孩。",
		"但是我覺得還是尊重你的想法，畢竟懷孕這段期間你會很辛苦。",
		"如果你想生，我會負起責任努力賺錢 ; 如果你不想生，我也會陪你。",
		"女：嗯，謝謝你。",
		"再給我時間思考一下吧，我現在無法做決定。",
		"我想趁爸媽發現之前，趕緊把小孩拿掉吧。",
		],
	...
	8601: {
		...
		story: [
			"「不讀書不一定就是壞孩子」",
			"媽：「爸爸的意思是你不讀書以後能幹嘛？考不上好大學怎麼找好工作？」",
			"爸：「我們花錢栽培你是要你成才，不是去搞那些五四三」",
		],
		btn_upper: {
			text: "沈默不語",
 			scene: 8701,
	...
	8701: {
		...
		line: [
			...
			{type: "received", message: "所以你沒說嗎？", timeout: 1},
			{type: "read", message: "嗯....我不敢說", timeout: 2},
			{type: "received", message: "那小孩怎麼辦？", timeout: 3},
			{type: "received", message: "你想要生下來還是？", timeout: 3},
			...
			{type: "received", message: "但是我覺得還是尊重你的想法，畢竟辛苦的是妳。", timeout: 4},
			{type: "received", message: "如果你想生，我會負起責任努力賺錢 ; 如果你不想生，我也會陪你。", timeout: 4},
			{type: "read", message: "嗯，謝謝你。", timeout: 2},
		],
		btn_upper: {
			text: "再給我時間思考一下吧，我現在無法做決定。",
	...
	8702: {
		...
		line: [
			...
			{type: "received", message: "沒有，我想說先去問問看，你不是也需要時間思考嗎？", timeout: 2},
			{type: "received", message: "等你決定好了，如果不想生我就去幫你拿藥。", timeout: 3},
			{type: "received", message: "如果想生，我再陪你去跟爸媽說。", timeout: 2},
	...
	8703: {
		...
		line: [
			...
			{type: "received", message: "你確定嗎？", timeout: 1},
			{type: "read", message: "嗯不然我們還有其他選擇嗎？可是要怎麼不讓爸媽知道？", timeout: 3},
			{type: "received", message: "你還記得我之前跟你說過，我朋友也是不小心懷孕，", timeout: 3},
	...
	9101: {
		...
		text_color: "#4d4d4d",
		story: [
		"老師：「好，那既然芷潔和子曜的爸爸媽媽都來了，我就可以開始討論了。",
		"希望今天的討論可以讓雙方家長瞭解現在的情況，也能和平地達成共識。",
		"我是學校的輔導主任，學校在接到來電後，隨即成立處理小組，",
		"我們已經將案子提交到性平會了，首先我們想知道這段關係是不是雙方合意的？」",
		],
		btn_left: {
			text: "繼續",
			scene: 9102,
	...
	9106: {
		...
		text_color: "#4d4d4d",
		story: [
		"子曜媽：「話不是這樣說的吧？他們兩個兩情相悅，你們怎麼一直把錯怪在我兒子身上。」",
		],
		btn_left: {
			text: "繼續",
			scene: 9107,
	...
	9107: {
		...
		text_color: "#4d4d4d",
		story: [
		"子曜爸：「對啊，而且子曜昨天也跟我說了他願意責任，這就是做錯事該有表現。」",
		],
		btn_left: {
			text: "繼續",
			scene: 9108,
	...
	9116: {
		...
		text_color: "#4d4d4d",
		story: [
		"爸爸：（打斷）「還能怎麼樣？她現在應該要做的就是好好讀書考好大學。",
		"懷孕的是她又不是你兒子，就直接拿掉吧。」",
		],
		btn_left: {
			text: "繼續",
	...
	9117: {
		description: "在學校-17",
		background: bg_school_girl_angry,
		text_color: "#4d4d4d",
		story: [
		"我：「爸你怎麼都不聽聽我的意見，就要擅自幫我做決定。",
		"你們都不要再吵了！我決定了」",
		],
		btn_upper: {
			text: "「我就是要把小孩生下來」",
	...
	10001: {
		...
		story: [
			...
			"醫生：「我有聽你爸媽說你的情況了，他們請我跟妳做清楚的解釋，",
			"最後再讓妳自己選擇要走哪條路。你想先聽哪一個注意事項？」",
		],
		btn_upper: {
			text: "關於人工流產的注意事項",
			scene: 10102,
	...
	10103: {
		...
		text_color: "#4d4d4d",
		story: [
			"「如果你想把小孩生下來，28週以內你只需要每個月定期回來檢查一次。",
			"你下一次產檢的時候，應該就可以聽到小孩心跳，我們也會給你媽媽手冊。",
			"只要按照手冊上的指示回診，並記錄你的健康狀況。",
			"如果你還會回到學校上課，要記得不能做激烈運動，也不要熬夜太晚睡。",
			"小孩生下來後，你就要負起當一個媽媽的責任了。",
			"好，那芷潔聽完之後，你做好決定了嗎？」",
		],
		btn_upper: {
			text: "嗯，我想生下來",
	...
	11002: {
		...
		page_turn: true,
		story: [
			"今天男友終於從朋友那拿了幾顆藥，說只要按照上面的步驟，小孩就會不見了。",
			"手裡拿著藥，我的內心好糾結，即便我知道吞了之後小孩就會不見，我還是很恐懼。",
			"我不知道吞了藥之後會發生什麼事？也不知道我是不是該跟他說再見？",
		],
		btn_upper: {
			text: "查一下不明的藥物",
			scene: 11101,
	...
	11107: {
		...
		story: [
			"男：「你怎麼沒吃？你在開玩笑嗎？",
			"所以你是想把小孩生下來嗎？",
			"那你怎麼都不跟我說？你打算隱瞞到什麼時候？」",
			"女：「我...對不起...我也不知道我在想什麼」",
			"男：「對不起是我太兇了，我應該要想到你一個人面對這件事有多不容易。不管怎麼樣，我都會陪你走下去」",
		],
		btn_left: {
			text: "繼續",
			scene: 11009,
	...
	99992: {
		...
		img_btn: [["./img/99/2/2-1.png", 99921], ["./img/99/1/2-2.png", 99922]],
	},
	99993: {
		description: "生結局-3",
		background: bg_os,
	...
	99932: {
		...
		story: [
			...
			"或許在不久的將來小美會是一位新鮮的大學生，所有美好的事物都在等待著她。",
		],
	},
	99941: {
		description: "生結局-41",
		...
		story: [
			...
			"有人說他轉學有人說他跑了。",
			"（說實話沒有吞：原本子曜說好會陪芷潔走下去，之後卻人間蒸發了，有人說他轉學有人說他跑了。）",
			...
			"小翰在外縣市賺錢養家，留下小美一個人面對來自四面八方的冷嘲熱諷，很是辛苦。",
			"然而對小美來說，不管遇到什麼問題，只要小孩能快樂幸福，再辛苦也是值得的。",
		],
	},
	99942: {
		description: "生結局-42",
		...
		story: [
			...
			"家長、老師甚至是身邊的朋友，都不知道小美已經懷孕七個月。",
			"儘管小美又回到學校上課，走在路上還是很多人都對他指指點點。",
