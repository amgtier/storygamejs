...
var scene = {
	...
	2010: {
		...
		{type: "received", message: "本來想說你要不要再驗一次啊", timeout: 4},
		{type: "read", message: "怕不太準嗎", timeout: 3},
		{type: "received", message: "但既然你驗兩次了....", timeout: 3},
		{type: "received", message: "沒關係 我明天帶你去看醫生", timeout: 3},
		{type: "received", message: "不管結果怎樣你不要想太多", timeout: 5},
		{type: "received", message: "有我在", timeout: 2},
		{type: "read", message: "好😭", timeout: 3},
	...
	2011: {
		...
		{type: "read", message: "我會拿這種事開玩笑嗎？", timeout: 3},
		{type: "received", message: "不是啦 我是嚇到了", timeout: 4},
		{type: "received", message: "你是用驗孕棒驗嗎", timeout: 4},
		{type: "received", message: "你只驗了一次嗎", timeout: 2},
		{type: "received", message: "你要不要再驗一次啊", timeout: 5},
		{type: "sent", img: "./img/2/05.png", timeout: 1},
		{type: "sent", img: "./img/2/06.png", timeout: 1},
		{type: "received", message: "不是說有些不太準嗎", timeout: 4},
	...
	7002: {
		...
		"爸爸皺了下眉頭：「蛤他不是跟你一樣才幾歲嗎？怎麼那麼年輕就懷孕了」",
		"媽媽跟著附和：「對啊，那她這樣讀書怎麼辦？高中都還沒畢業。」",
		"「ㄜ我不知道誒，就只是聽說。」我的手心不停冒汗。",
		"「你現在要做的就是好好讀書，不要跟別人學壞了！」爸爸怎麼說都說一樣的。",
	...
	8601: {
		...
		story: [
			"「不讀書不一定就是壞孩子」",
			"「爸爸的意思是你不讀書以後能幹嘛？考不上好大學怎麼找好工作？」",
			"爸爸接著說：「我們花錢栽培你是要你成才，不是去搞那些五四三！」",
		],
		btn_upper: {
			text: "沈默不語",
 			scene: 8701,
	...
	9103: {
		...
		text_color: "#4d4d4d",
		story: [
		"「現在不管是不是強暴，你家兒子就是把我女兒肚子搞大了。」爸爸的手指向子曜。",
		],
		btn_left: {
			text: "繼續",
			scene: 9104,
