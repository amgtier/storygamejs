...
var scene = {
	...
	6002: {
		...
		"我趕緊安慰他：「當初發生關係都是你請我願的，我們也做好保護措施了，事情發生也不能怪你。」",
 ...
 // 			scene: 8301,
	...
	8601: {
		...
		story: [
			...
			"還沒等媽媽說完，爸爸就接著說：「我們花錢栽培你是要你成才，不是去搞那些五四三！」",
		],
		btn_upper: {
			text: "沈默不語",
 			scene: 8701,
...
"但是我要為我的決定負責，不要妄想把孩子生下來丟給爸媽照顧。",
			...
			"「我有聽你爸媽說你的情況了，他們請我跟妳做清楚的解釋，最後再讓妳自己選擇要走哪條路。你想先聽哪一個注意事項？」",
		],
		btn_upper: {
			text: "關於人工流產的注意事項",
			scene: 10102,
	...
	11113: {
		...
		text_color: "#4d4d4d",
		story: [
			"「我看你這次月經來氣色好差，又要忙段考，所以我燉雞湯幫妳補補身子。」",
